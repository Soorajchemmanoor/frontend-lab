...
function Post(){
    ...
    return (
        <>
            ...
            <div className="mx-auto max-w-xl p-4 my-8">
                ...
                <div className="flex justify-between items-center gap-4 mt-4  mb-4">
                    <div className="flex items-center gap-2">
                        ...
                        <div className="text-left" >
                            <h2 className="text-xl font-bold">{user.name} <span className="text-sm text-neutral-400">@{user.username}</span> </h2>
                ...
                <img src={post.image} alt={post.caption} className="w-full h-auto object-cover mb-4  border-white shadow-xl " />
